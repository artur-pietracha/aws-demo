...
deploy_test:
	...
	$(HEROKU_PUSH_CONTAINER) test-aws-test
	$(HEROKU_RELEASE_CONTAINER) test-aws-test

deploy_stage:
	$(INSTALL_HEROKU_CLI_AND_LOGIN_AND_SETUP_DOCKERFILES)
	$(HEROKU_PUSH_CONTAINER) test-aws-stage
	$(HEROKU_RELEASE_CONTAINER) test-aws-stage

deploy_prod:
	$(INSTALL_HEROKU_CLI_AND_LOGIN_AND_SETUP_DOCKERFILES)
	$(HEROKU_PUSH_CONTAINER) test-aws-prod
	$(HEROKU_RELEASE_CONTAINER) test-aws-prod
