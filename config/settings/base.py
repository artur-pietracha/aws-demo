...
ROOT_DIR = environ.Path(__file__) - 3  # (test_aws/config/settings/base.py - 3 = test_aws/)
APPS_DIR = ROOT_DIR.path("test_aws")
...
LOCAL_APPS = [
    "test_aws.applesignin",
    "test_aws.core.apps.CoreConfig",
    "test_aws.user.apps.UserConfig",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ["test_aws.core.authentication.Authentication"],
...
# Allauth
SOCIALACCOUNT_ADAPTER = "test_aws.core.adapters.SocialAccountAdapter"
